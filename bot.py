...
def main():
    ...
    try:
        ...
        if token and repo:
            files_to_pull = ["state.json","shadow_state.json","shadow_long_state.json","shadow_shorts.csv","shadow_longs.csv","equity_curve.csv","strategy_audit.csv","rejected_signals.csv","symbol_performance.csv","trade_explanations.json"]
